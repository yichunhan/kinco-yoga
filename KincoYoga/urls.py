...
urlpatterns = [
    ...
    url(r'^coach/(\w+)/$', 'mainsite.views.coaches'),
    url(r'^classes/$', 'mainsite.views.classes'),
    url(r'^class/(\w+)/$', 'mainsite.views.classes'),
    url(r'^videos/(class|tv)/$', 'mainsite.views.videos'),
    url(r'^experiences/(teacher|student)/$', 'mainsite.views.experiences'),
    url(r'^articles/$', 'mainsite.views.articles'),
    url(r'^faq/$', 'mainsite.views.faq'),
